...
\begin{gather}
        ...
        \end{aligned}
\end{gather}
\pb{should define $D$ as well as the fact that $d^{1/2}$ means element-wise square root}
...
\begin{equation}
    ...
    \frac{\partial}{\partial\beta}(\cdot) =-X^Tb+X^TU^T\mathbf{1}+n\lambda\frac{\partial||\beta||_1}{\partial\beta}
\end{equation}
