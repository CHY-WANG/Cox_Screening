...
\pb{Seems like the notation here would be simpler / more consistent if we used $\Theta_0$, $\Theta_1$, $\mathcal{F}_0$, $\mathcal{F}_1$, and so on}
...
\begin{algorithm}[H]
    ...
    \For{$l\xleftarrow{}$ 1 \KwTo L}{
        ...
        \For{$j\xleftarrow{}$ 1 \KwTo p}{
            \uIf{$T_j(\lambda_l,\lambda_{l^*};\Theta_{\lambda_{l^*}})<n\lambda_l$}{
